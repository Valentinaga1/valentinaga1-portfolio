      ...
      <div className={styles["about__columns"]}>
        ...
        <div>
          <div className={styles["about__text-container"]}>
            {/* <p className={styles["about__text"]}>{`I'm Valentina, originally a financial engineer who embarked on an exciting journeyinto the world of software development. Over the past two years, I've delved deep into web2 technologies like Next.js, GraphQL, ReactJS, and MongoDB. This journey has allowed me to craft interactive features for websites, blending my financial engineering background's analytical rigor with forward-thinking software solutions`}</p>
            <p className={styles["about__text"]}>{`Beyond the digital realm, you'll often find me exploring the world through travel or gracefully gliding on roller skates. My love for coffee fuels both my work and adventures. Recently, I've taken significant steps into web3 and blockchain by  completing my training at the Polkadot Blockchain Academy, where I acquired essential skills to navigate this revolutionary domain. With my unique blend of financial background, web development experience, and emerging blockchain knowledge, I'm excited to contribute, innovate, and craft solutions in this dynamic space.`}</p>
            <p className={styles["about__text"]}>{`Recently, I've taken significant steps into web3 and blockchain by completing my training at the Polkadot Blockchain Academy, where I acquired essential skills to navigate this revolutionary domain. I'm currently dedicated to studying and improving my knowledge in web3 technologies, including Substrate, FRAME, Polkadot, and various other blockchain technologies and smart contracts.`}</p>
            <p className={styles["about__text"]}>{`With my financial background, engineer, web development experience, and emerging blockchain knowledge, I'm excited to contribute, innovate, and craft solutions in this dynamic space.`}</p> */}
